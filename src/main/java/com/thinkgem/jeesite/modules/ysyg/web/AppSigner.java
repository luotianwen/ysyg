...
public class AppSigner {
    ...
    public static void main(String[] args) {
        ...
        //13dd5bdb92234489b816cd8e98429209
        Credential credential = new Credential("2ffe2c18c235491ab005dada6185770c", "52efbdda66304e41a0409499f01f0df6");
        AppSigner appSigner = new AppSigner(credential);

        String httpMethod = "GET";
        URI uri = URI.create("http://gwgp-h4bqkmub7dg.n.bdcloudapi.com/day?city=北京");
